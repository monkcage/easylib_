...
template EASY_EXPORT Fmt::Fmt(const char *fmt, char);

template EASY_EXPORT Fmt::Fmt(const char *fmt, short);
template EASY_EXPORT Fmt::Fmt(const char *fmt, unsigned short);
template EASY_EXPORT Fmt::Fmt(const char *fmt, int);
template EASY_EXPORT Fmt::Fmt(const char *fmt, unsigned int);
template EASY_EXPORT Fmt::Fmt(const char *fmt, long);
template EASY_EXPORT Fmt::Fmt(const char *fmt, unsigned long);
template EASY_EXPORT Fmt::Fmt(const char *fmt, long long);
template EASY_EXPORT Fmt::Fmt(const char *fmt, unsigned long long);

template EASY_EXPORT Fmt::Fmt(const char *fmt, float);
template EASY_EXPORT Fmt::Fmt(const char *fmt, double);
